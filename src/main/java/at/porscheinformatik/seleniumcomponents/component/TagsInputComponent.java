...
public class TagsInputComponent extends HtmlComponent
{
    ...
    {
        private final SeleniumComponentListFactory<HtmlComponent> itemFactory =
            new SeleniumComponentListFactory<>(this, selectByTagName("li"), HtmlComponent::new);
        ...
        public void selectEntry(String value, int selectSuggestion)
        {
            ...
            SeleniumComponentList<HtmlComponent> filteredList =
                matchingList.filter(item -> item.getText().contains(value));

...
public class ClarityPasswordContainerComponent extends ClarityFormControlContainer {
    public static ClarityPasswordContainerComponent within(SeleniumComponent parent) {
        return new ClarityPasswordContainerComponent(parent,
    ...
    public static ClarityPasswordContainerComponent byFormControlName(SeleniumComponent parent,
    ...
    public static ClarityPasswordContainerComponent byLabel(SeleniumComponent parent, String label) {
        String xpath = String.format(
                ".//clr-password-container[.//label[contains(@class, 'clr-control-label') and contains(text(),'%s')]]",
                label);
    ...
    /**
     * Clear the input control by selecting the entire text and then backspacing.
     * This is necessary as otherwise the form control won't be marked as dirty.
     */
    public void clear() {

...
public class ClarityRadioContainerComponent extends ClarityFormControlContainer {
    ...
    public static ClarityRadioContainerComponent byTestId(SeleniumComponent parent, String testId) {
        return new ClarityRadioContainerComponent(
            parent,
    ...
    private final SeleniumComponentListFactory<ClarityRadioComponent> radios = new SeleniumComponentListFactory<>(
        this,
        WebElementSelector.selectByTagName("clr-radio-wrapper"),

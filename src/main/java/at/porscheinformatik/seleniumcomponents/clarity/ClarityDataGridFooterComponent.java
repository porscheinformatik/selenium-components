...
public class ClarityDataGridFooterComponent extends AbstractSeleniumComponent {
    ...
    private static class ClarityDataGridPaginationList extends AbstractSeleniumComponent {
        ...
        private final ButtonComponent previousButton = new ButtonComponent(
            this,
            selectByClassName("pagination-previous")
        );
        ...
        private final HtmlComponent totalPages = new HtmlComponent(
            this,
            selectByAttribute("aria-label", "Total Pages")
        );
